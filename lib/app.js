...
app.get('/auth/google/callback',
    ...
    function (req, res) {
        try {
            ...
            res.redirect(`/auth/google/success?:${req._passport.session.user.email}:${req._passport.session.user.firstName}:${req._passport.session.user.email}`)
...
app.get('/auth/google/success/:email:firstName:exisiting', isLoggedIN, (req, res) =>
